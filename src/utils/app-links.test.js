...
it('generates correct own link', () => {
  ...
  expect(generateLink(swapState)).toBe('http://localhost/#ccy1=eth&ccy1v=50&ccy1Addr=0xe66D664507EF1251fC6B8cCf1fD1684274A3e9e3&ccy1CounterPartyAddr=0x3461e2e8a76a0554c8dC62cF42d8C75A333319EB&ccy2=btc&ccy2v=10&ccy2Addr=12wghKSUJCEgwwQjAuLVHoHuqZ18pPCjUK&ccy2CounterPartyAddr=19xQT3DfkTzVp7w6hoHP2d2zhra8mGHzn3&aFundHash=0xd2e451e21d625564844d5aa74c9a0a4c9b5a607303ccd738e95dbea83cec9304&aStartBlock=123&bStartBlock=456&secretHash=secrethash&aExpiration=123&bExpiration=456&isPartyB=false')
})
...
it('generates correct swap state', () => {
  ...
  expect(generateSwapState({hash: '#aFundHash=0xd2e451e21d625564844d5aa74c9a0a4c9b5a607303ccd738e95dbea83cec9304&aStartBlock=123&bStartBlock=456&ccy1=eth&ccy1Addr=0xe66D664507EF1251fC6B8cCf1fD1684274A3e9e3&ccy1CounterPartyAddr=0x3461e2e8a76a0554c8dC62cF42d8C75A333319EB&ccy1v=50&ccy2=btc&ccy2Addr=12wghKSUJCEgwwQjAuLVHoHuqZ18pPCjUK&ccy2CounterPartyAddr=19xQT3DfkTzVp7w6hoHP2d2zhra8mGHzn3&ccy2v=10&isPartyB=false&secretHash=secrethash&aExpiration=123&bExpiration=456'})).toEqual(swapState)
})
