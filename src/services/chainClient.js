...
btcClient.addProvider(new providers.bitcoin.BitcoinRPCProvider(
  localStorage.btcRpc || window.btcRpc || 'http://localhost:18332',
  localStorage.btcRpcUser || window.btcRpcUser || 'bitcoin',
  localStorage.btcRpcPass || window.btcRpcPass || 'local321'
))
